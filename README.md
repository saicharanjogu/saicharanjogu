...
|---|---|---|
| **Bookmore** — AI Lead Qualification | Claude Opus 4.5 · Agent Orchestration · LangSmith · DeepEval · Promptfoo | 12% → 38% conv rate (3x) · $15K+ MRR |
| **Fotos CRM** — AI-Enhanced B2B SaaS | RAG Pipelines · AWS · NVIDIA Inception | 60% faster delivery · 25% retention lift |
| **Skyvisa** — AI Forms UX | Predictive field validation · LLM completion | 40% → 64% task success · 35% support drop |
| **DRDO Defense App** — Mission-Critical AI | Secure UX Architecture · Enterprise protocols | Zero compliance issues |
...
```
LLMs          Claude / GPT-4 / Prompt Engineering / Vibecoding
Pipelines     RAG · Agent Orchestration · LangChain · Vector DBs · Embeddings
Evals         LangSmith · DeepEval · Promptfoo · MECE outcome frameworks
Infra         AWS · NVIDIA AI Workloads · API Design · System Architecture
Product       PRD Writing · AI Success Metrics · Paid Pilot Validation · RICE
```
...
- **GetCam** (2020–2022) — Co-founded a P2P camera rental marketplace. First product, first 10 customers, first rejection from investors — bootstrapped through it.
- **MBA, Product Management** — Kairos Business School (2024)
- **B.Tech, IT** — BVRIT Narsapur (2023)
- **Partnerships** — AWS Startups · NVIDIA Inception · Meta Tech Provider

---

## Recognition

- Best Innovation in Telangana — ORL Makers Garage
- Top 50 Under-22 Founders in India — Kairos Fellowship
- Google Data Analytics Professional · Product-led Certification (Pendo.io) · Design Thinking (Autodesk)
